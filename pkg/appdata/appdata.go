...
// Dir returns an operating system specific directory to be used for
// storing application data for an application.  See Dir for more
...
// TstAppDataDir makes the internal Dir function available to the test
// package.
