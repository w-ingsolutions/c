...
func NewWingUIicons() (i map[string]*widget.Icon) {
	...
	i["Betonski"] = mustIcon(widget.NewIcon(Betonski))
	i["Bravarski"] = mustIcon(widget.NewIcon(Bravarski))
	i["Fasaderski"] = mustIcon(widget.NewIcon(Fasaderski))
	i["Gipsarski"] = mustIcon(widget.NewIcon(Gipsarski))
	i["Istraživački"] = mustIcon(widget.NewIcon(Istrazivacki))
	i["Izolaterski"] = mustIcon(widget.NewIcon(Izolaterski))
	i["Kamenorezački"] = mustIcon(widget.NewIcon(Kamenorezacki))
	i["Kanalizacija"] = mustIcon(widget.NewIcon(Kanalizacija))
	i["Keramičarski"] = mustIcon(widget.NewIcon(Keramicarski))

	i["Razni"] = mustIcon(widget.NewIcon(Kovacki))

	i["Likorezački"] = mustIcon(widget.NewIcon(Likorezacki))
	i["Limarski"] = mustIcon(widget.NewIcon(Limarski))
	i["Livački"] = mustIcon(widget.NewIcon(Livacki))
	i["Molersko"] = mustIcon(widget.NewIcon(Molerski))
	i["Parketarski"] = mustIcon(widget.NewIcon(Parketarski))
	i["Podopolagački"] = mustIcon(widget.NewIcon(Podopolagacki))
	i["Pokrivački"] = mustIcon(widget.NewIcon(Pokrivacki))
	i["Pripremno"] = mustIcon(widget.NewIcon(Pripremni))
	i["Roletnarski"] = mustIcon(widget.NewIcon(Roletnarski))
	i["Demontaže"] = mustIcon(widget.NewIcon(Rusenja))
	i["Sanitarije"] = mustIcon(widget.NewIcon(Sanitarije))
	i["Staklorezački"] = mustIcon(widget.NewIcon(Staklorezacki))
	i["Stolarski"] = mustIcon(widget.NewIcon(Stolarija))
	i["Građevinska"] = mustIcon(widget.NewIcon(Stolarski))
	i["Suvomontažni"] = mustIcon(widget.NewIcon(Suvomontazni))
	i["Tapetarski"] = mustIcon(widget.NewIcon(Tapetarski))
	i["Teracerski"] = mustIcon(widget.NewIcon(Teracerski))
	i["Tesarski"] = mustIcon(widget.NewIcon(Tesarski))
	i["Vodovod"] = mustIcon(widget.NewIcon(Vodovod))
