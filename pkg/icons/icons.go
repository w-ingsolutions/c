...
func NewWingUIicons() (i map[string]*widget.Icon) {
	...
	i["Istrazivacki"] = mustIcon(widget.NewIcon(Istrazivacki))
	i["Izolaterski"] = mustIcon(widget.NewIcon(Izolaterski))
	i["Kamenorezacki"] = mustIcon(widget.NewIcon(Kamenorezacki))
	i["Kanalizacija"] = mustIcon(widget.NewIcon(Kanalizacija))
	i["Keramicarski"] = mustIcon(widget.NewIcon(Keramicarski))
	i["Kovacki"] = mustIcon(widget.NewIcon(Kovacki))
	i["Likorezacki"] = mustIcon(widget.NewIcon(Likorezacki))
	i["Limarski"] = mustIcon(widget.NewIcon(Limarski))
	i["Livacki"] = mustIcon(widget.NewIcon(Livacki))
	i["Molerski"] = mustIcon(widget.NewIcon(Molerski))
	i["Parketarski"] = mustIcon(widget.NewIcon(Parketarski))
	i["Podopolagacki"] = mustIcon(widget.NewIcon(Podopolagacki))
	i["Pokrivacki"] = mustIcon(widget.NewIcon(Pokrivacki))
	i["Pripremni"] = mustIcon(widget.NewIcon(Pripremni))
	...
	i["Stolarski"] = mustIcon(widget.NewIcon(Stolarski))
