...
func (p *WingUIpanel) ScrollBarLayout(g *layout.Context, panel *gel.Panel) func(gtx C) D {
	return func(gtx C) D {
...
func (p *WingUIpanel) bodyLayout(g *layout.Context, panel *gel.Panel) func(gtx C) D {
	return func(gtx C) D {
		return layout.Flex{
			Axis: layout.Vertical,
		}.Layout(*g,
